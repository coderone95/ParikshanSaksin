...
(function (global, factory) {
  ...
  var toolbar = renderer.create('<div class="note-toolbar panel-heading" role="toolbar" id="note-toolbar"></div></div>');
  var editingArea = renderer.create('<div class="note-editing-area"/>');
  var codable = renderer.create('<textarea class="note-codable" role="textbox" aria-multiline="true"/>');
  var editable = renderer.create('<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true" id="editableNote"/>');
